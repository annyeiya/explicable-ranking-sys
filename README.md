...
<i>Работа реализована в рамках ВКР ЮУрГУ, 2026 по теме: Разработка интеллектуальной системы ранжирования уполномоченных органов государственной власти для подготовки ответов на обращения граждан

По работе опубликовына публикации: 
* Нефедова А.А. Модель ИИ для объяснимой маршрутизации обращений граждан в органы власти – ИИ: научные достижения и прикладные задачи. – ЮГУ, 2026.
* Нефедова  А.А., Карпета Т.В. Моделирование интеллектуального алгоритма ранжирования уполномоченных инстанций в задачах подготовки ответов на запросы – Вестник ЮУрГУ серия «Математическое моделирование и программирование» - 2026.</i>
